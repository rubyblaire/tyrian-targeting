...
- Restore packages
- Build Release
- Search `bin\Release` for `TyrianTargeting.dll`
- Mirror the built plugin into XIVLauncher `devPlugins`

Default dev plugin output:

```text
%APPDATA%\XIVLauncher\devPlugins\TyrianTargeting
```

To skip mirroring:

```powershell
.\build.ps1 -SkipDevPluginMirror
```

To use a custom `devPlugins` path:

```powershell
.\build.ps1 -DevPluginsPath "C:\Path\To\XIVLauncher\devPlugins"
```

---

## Pluginmaster Example

```json
[
  {
    "Author": "Ruby Blaire",
    "Name": "Tyrian Targeting",
    "InternalName": "TyrianTargeting",
    "AssemblyVersion": "0.2.18.0",
    "TestingAssemblyVersion": "0.2.18.0",
    "Description": "Tyrian Targeting is a GW2-inspired manual targeting refinement plugin for FFXIV. It improves tab targeting with configurable target cycling, called targets, target markers, presets, filters, and theme options while keeping all targeting fully manual.",
    "ApplicableVersion": "any",
    "DalamudApiLevel": 15,
    "TestingDalamudApiLevel": 15,
    "Punchline": "GW2-inspired manual tab targeting for FFXIV.",
    "RepoUrl": "https://github.com/rubyblaire/tyrian-targeting",
    "DownloadLinkInstall": "https://github.com/rubyblaire/tyrian-targeting/releases/download/v0.2.18.0/TyrianTargeting.zip",
    "DownloadLinkUpdate": "https://github.com/rubyblaire/tyrian-targeting/releases/download/v0.2.18.0/TyrianTargeting.zip",
    "DownloadLinkTesting": "https://github.com/rubyblaire/tyrian-targeting/releases/download/v0.2.18.0/TyrianTargeting.zip",
    "IconUrl": "https://raw.githubusercontent.com/rubyblaire/tyrian-targeting/main/images/icon.png",
    "Tags": [
      "Targeting",
      "Combat",
      "Utility",
